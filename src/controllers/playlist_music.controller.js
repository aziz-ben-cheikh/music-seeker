...
class playlist_musicController {
    ...
    async createplaylist_music(req, res) {
        try {
            const playlist_music = await playlist_musicService.createplaylist_music(req.body);
    ...
    async getallplaylist_music(req, res) {
        try {
            const playlist_musics = await playlist_musicService.getallplaylist_music();
    ...
    async getplaylist_musicbyid(req, res) {
        try {
            const playlist_music = await playlist_musicService.getplaylist_musicbyid(req.params.id);
    ...
    async updateplaylist_music(req, res) {
        try {
            const updatedplaylist_music = await playlist_musicService.updateplaylist_music(req.params.id, req.body);
    ...
    async deleteplaylist_music(req, res) {
        try {
            const result = await playlist_musicService.deleteplaylist_music(req.params.id);
            res.json(result);
        } catch (error) {
            if (error.name === 'appError' && error.statuscode === 404) {
                res.status(404).json({ error: error.message });
